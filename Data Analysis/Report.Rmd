...
```{r}
ggmap(atlantic_map, extent = "device") + geom_density2d(data = major_winds, aes(x = Longitude, y = Latitude), size = 0.3) + stat_density2d(data = major_winds, aes(x = Longitude, y = Latitude, fill = ..level.., alpha = ..level..), size = 0.01,bins = 16, geom = "polygon") + scale_fill_gradient(low = "green", high = "red") + scale_alpha(range = c(0, 0.3), guide = FALSE)
```
